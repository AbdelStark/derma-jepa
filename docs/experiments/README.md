...
| [EXP-009 plan](EXP-009-non-ham10000-dermoscopy-pretrain-plan.md) | planned | public | — | — | — | — | Full launch contract for the non-HAM10000 dermoscopy pretraining partition, including corpus audit gates, HF Jobs pipeline, machine choices, cost estimates, and decision thresholds. |
