...
| [EXP-004](EXP-004-ham10000-jepa-mixed-train-held-out-2-v1.md) | `ham10000-hf-dinov2-exp004-v1` | public | 2026-04-23 | 0.2491 [0.2296, 0.2698] | Pixel L2 = 0.5802 [0.5560, 0.6058] | **−0.3311** | Below-random + inverted; mixed-family training doesn't rescue generalization; linear-over-frozen-DINOv2 identified as bottleneck |
| [EXP-005](EXP-005-ham10000-jepa-mlp-predictor-v1.md) | `ham10000-hf-dinov2-exp005-v1` | public | 2026-04-24 | 0.2702 [0.2491, 0.2926] | Pixel L2 = 0.5802 [0.5560, 0.6058] | **−0.3101** | MLP predictor underfit under inherited optimiser (train AUROC 0.572); test AUROC ≈ DINOv2 baseline. Capacity hypothesis not cleanly tested; backbone still implicated. |
