...
EXP-007  & DermLIP B/16\textsuperscript{$\star$}    & linear  & SGD  & $1.000$ & $\mathbf{0.944 \pm 0.003}$\textsuperscript{\ddag} & $\mathbf{+0.364}$ \\
\bottomrule
\end{tabular}
...
five seeds. \textsuperscript{\ddag} Mean $\pm$ std across five seeds.
