...
RUNS = [
    (
        "EXP-004",
        "ham10000-hf-dinov2-exp004-v1",
        "DINOv2 / linear / SGD",
        "#9aa3b2",
    ),
    (
        "EXP-005",
        "ham10000-hf-dinov2-exp005-v1",
        "DINOv2 / MLP / SGD",
        "#9aa3b2",
    ),
    (
        "EXP-006a",
        "ham10000-hf-dinov2-exp006a-v1",
        "DINOv2 / MLP / Adam",
        "#9aa3b2",
    ),
    (
        "EXP-006b",
        "ham10000-hf-clip-exp006b-v1",
        "CLIP / linear / SGD",
        "#9aa3b2",
    ),
    (
...
def main() -> int:
    ...
    for label, descr, train, test, colour in points:
        ax.scatter(
            train, test, s=70, color=colour, edgecolors="#222", linewidth=0.6, zorder=3
        )
    ...
    ax.set_title("Train-vs-test AUROC on the EXP-004 proxy", fontsize=10)
