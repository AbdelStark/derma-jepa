...
publicly available dermoscopy datasets and dermatology-website content. We use
both as third-party frozen weights, not as artefacts to evaluate in their own
right. The paper makes no claim about either model beyond the test $\auroc$
each produces under our specific probe.
