...
Init $W_{2}$        & ---       & zero (so $g_{\theta} = $ identity at step zero) \\
Init biases         & zero      & zero \\
Optimiser           & SGD       & SGD (EXP-005) \,$\vert$\, Adam (EXP-006a) \\
Learning rate       & $3\!\times\!10^{-2}$ & $3\!\times\!10^{-2}$ \,$\vert$\, $10^{-3}$ \\
Weight decay        & $10^{-3}$ on $(W - I)$ & $10^{-3}$ on $(W_{1}, W_{2})$ \,$\vert$\, $10^{-4}$ (decoupled) \\
Batch size          & $128$     & $128$ \\
Epochs              & $200$     & $200$ \\
...
Bootstrap resamples & $1{,}000$ & $1{,}000$ \\
Bootstrap level     & per-pair  & per-pair \\
