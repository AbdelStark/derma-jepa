...
percentile bootstrap $95\%$ confidence interval. The implementation is at
\texttt{src/derma\_jepa/metrics.py:66} (\texttt{bootstrap\_auroc\_ci}); the
unit tests at \texttt{tests/test\_metrics.py} cover the AUROC point
estimate, the bootstrap CI shape, the equal-error-rate threshold, and the
