...
\item \textbf{Empirical (negative-as-partition).} Frozen BiomedCLIP ---
      a ``biomedical-figure pretraining without HAM10000'' backbone
      whose dermatology fraction is undocumented but plausibly small
      --- lifts only $+0.04$ over web CLIP, narrowing the open question
      to dermoscopy-rich pretraining.
