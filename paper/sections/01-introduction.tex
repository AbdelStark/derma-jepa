...
\citep{yan2025derm1m}, does not name HAM10000 among its sources but documents
no decontamination against it (Appendix~\ref{app:contamination}), so HAM10000
image-level overlap cannot be excluded; and the
