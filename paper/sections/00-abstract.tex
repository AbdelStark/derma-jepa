...
transfer}: DermLIP's Derm1M corpus does not list HAM10000 as a source yet
documents no decontamination against it, so HAM10000 image-level overlap cannot
be ruled out, and the experiments reported here cannot separate
